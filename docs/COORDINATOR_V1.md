...
После E выполнен этап F: атомарное сохранение и replay persistence описаны в
[PERSISTENCE_V1.md](PERSISTENCE_V1.md) и проверены на отдельном PostgreSQL 17.
Далее API первого и frontend G второго. Завершение F не объявляет сквозной
API/UI готовым продуктом.
