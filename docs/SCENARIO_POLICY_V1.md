...
пока не реализованы D–E, вместо неверного no_feasible_option при наличии допустимого
...
он реализовал задержку ЛИМС 240 минут и SnapshotProvider. Required manifest и
численные единицы/шкалы ещё не переданы. Этап C разработчика 2 теперь реализован:
